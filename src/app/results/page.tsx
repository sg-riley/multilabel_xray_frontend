    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-xl font-700 text-slate-700 mb-2">Tidak Ada Hasil Analisis</h2>
          <p className="text-slate-500 text-sm mb-6">
            Belum ada data analisis. Silakan upload gambar X-ray terlebih dahulu.
          </p>
          <button
            onClick={() => router.push("/")}
            className="px-6 py-3 bg-gradient-to-r from-sky-500 to-blue-600 text-white font-600 rounded-xl shadow-lg shadow-sky-200 hover:shadow-sky-300 transition-all"
          >
            Kembali ke Upload
          </button>
        </div>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl font-800 text-slate-900">Hasil Analisis X-Ray</h1>
          <p className="text-slate-500 text-sm mt-1">
            Diproses dalam{" "}
            <strong className="text-sky-600">{(result.processing_time_ms / 1000).toFixed(2)} detik</strong>
          </p>
        </div>
        ...
        <button
          ...
          onClick={handleReset}
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border-2 border-sky-200 text-sky-700 font-600 text-sm hover:bg-sky-50 hover:border-sky-300 transition-all"
        >
      ...
      <div className="flex items-start gap-3 px-5 py-4 rounded-xl bg-amber-50 border border-amber-200 mb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-sm font-700 text-slate-500 uppercase tracking-wider mb-3">
              Ringkasan Penyakit
            </h2>
